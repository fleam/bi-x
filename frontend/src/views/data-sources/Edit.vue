...
const fetchDataSource = async () => {
  try {
    ...
    form.db_type = dataSource.db_type
    ...
    form.file_path = dataSource.file_path
    form.api_url = dataSource.api_url
    form.api_method = dataSource.api_method
    form.api_headers = dataSource.api_headers ? JSON.stringify(dataSource.api_headers, null, 2) : null
    form.api_body = dataSource.api_body ? JSON.stringify(dataSource.api_body, null, 2) : null
    form.connection_pool = dataSource.connection_pool
    form.refresh_interval = dataSource.refresh_interval
    form.is_active = dataSource.is_active
  } catch (error) {
...
const handleSubmit = async () => {
  try {
    ...
    const submitData = {
      ...
      api_headers: form.api_headers ? JSON.parse(form.api_headers) : null,
      api_body: form.api_body ? JSON.parse(form.api_body) : null,
      connection_pool: form.connection_pool,
      refresh_interval: form.refresh_interval,
      is_active: form.is_active
    }

    await axios.put(`/api/v1/sources/${form.id}`, submitData)
